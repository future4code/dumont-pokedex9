    ...
    return (
        <div className='container'>
            ...
            <div className='status1'>
                ...
                <div className="attack">attack: {props.attack}</div>
                <div className="defense">defense: {props.defense}</div>
                <div className="special-attack">special-attack: {props.specialAttack}</div>
                <div className="special-defense">special-defense: {props.specialDefense}</div>
